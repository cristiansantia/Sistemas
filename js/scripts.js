(function() {
    ...
    $("html").niceScroll({styler:"fb",cursorcolor:"#68ae00", cursorwidth: '10', cursorborderradius: '10px', background: '#FFFFFF', spacebarenabled:false, cursorborder: '0',  zindex: '1000'});
