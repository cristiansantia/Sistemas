<?php
	...
	$pdf->Cell(53,9,utf8_decode("Nombre de la Institución: "), 0, 0, 'L');
	$pdf->SetFont('Arial','',12);
	$pdf->Cell(40,9, $datosInstitucion['nombreinst'], 0, 1);
	$pdf->SetFont('Arial','B',12);
	$pdf->Cell(23,9,utf8_decode("Dirección: "), 0, 0, 'L');
	$pdf->SetFont('Arial','',12);
	$pdf->Cell(40,9, $datosInstitucion['direccioninst'], 0, 1);
	$pdf->SetFont('Arial','B',12);
	$pdf->Cell(50,9,utf8_decode("Fecha de Inventario al:"), 0, 0, 'L');
	$pdf->SetFont('Arial','',12);
	$pdf->Cell(32,9, date("d-m-Y") . ".", 0, 1);
	$pdf->SetFont('Arial','B',12);
	$pdf->Cell(39,9,utf8_decode("Rango de Fechas:"), 0, 0, 'L');
	$pdf->SetFont('Arial','',12);
	$pdf->Cell(15,9, "De  " . $fechaI . "  a  " . $fechaF . "." , 0, 1);
	...
	$sqlMobiliario = "SELECT 
					...
					WHERE 
						mob.activo = 1
					AND
						mob.fechaadquisicion BETWEEN '$fechaI' AND '$fechaF'
					";
	...
	$pdf->Output("", "Reporte Mobiliario Por Fechas.pdf");
?>