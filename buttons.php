...
<div class="inner-block">
     <div class="buttons-main">
           <div class="progressbar-heading btn-main-heading">
			...
			<h1>
				<button class="btn btn-primary hvr-grow">Guardar &nbsp;<span class="fa fa-save"></span></button>
				<button class="btn btn-primary hvr-grow">Buscar &nbsp;<span class="fa fa-search"></span></button>
				<button class="btn btn-success hvr-grow">Editar &nbsp;<span class="fa fa-pencil-square-o"></span></button>
				<button class="btn btn-danger hvr-grow">Eliminar &nbsp;<span class="fa fa-trash-o"></span></button>
				<button class="btn btn-warning hvr-grow">Generar PDF &nbsp;<span class="fa fa-file-pdf-o"></span></button>
				<button class="btn btn-info hvr-grow">Ayuda &nbsp;<span class="fa fa-info-circle"></span></button>
				<button class="btn btn-default hvr-grow">Limpiar &nbsp;<span class="fa fa-eraser"></span></button>
			</h1>
